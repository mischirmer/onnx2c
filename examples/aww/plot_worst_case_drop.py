            ...
            for value in values:
                ...
                for yi, mech in enumerate(mechs):
                    ...
                    for xi, layer in enumerate(layer_union):
                        ...
                        if v_overall is not None or v_undetected is not None:
                            rows_csv.append(
                                {
                                    "quant": quant,
                                    "mechanism": mech,
                                    ...
                                    "worst_drop": f"{(v_undetected if v_undetected is not None else 0.0):.8f}",
                                    "worst_drop_overall": f"{(v_overall if v_overall is not None else 0.0):.8f}",
                                    "worst_drop_undetected": f"{(v_undetected if v_undetected is not None else 0.0):.8f}",
                                }
                            )
